        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6 bg-gradient-to-br from-background via-background/95 to-primary/5 border-primary/10 shadow-lg">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-xl font-bold text-primary bg-gradient-to-r from-primary to-primary/70 bg-clip-text ">
          ...
          <Card className="p-6 bg-gradient-to-br from-background via-background/95 to-secondary/5 border-secondary/10 shadow-lg">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-xl font-bold text-primary bg-gradient-to-r from-secondary to-secondary/70 bg-clip-text ">
                  Model Performance
                </h3>
                <p className="text-sm text-muted-foreground flex items-center mt-1">
